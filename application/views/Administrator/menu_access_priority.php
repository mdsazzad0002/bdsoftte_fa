...
<div id="userAccess">
    ...
    <div class="row" id="accessRow">
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="sales">
                    ...
                    <li><input type="checkbox" class="access" value="special_report" v-model="access"> Daily Report </li>
        ...
        <div class="col-md-3">
            ...
            <?php endif; ?>
            <div class="group">
                <input type="checkbox" id="hrPayroll" class="group-head" @click="onClickGroupHeads"> <strong>Manage HR</strong>
                <ul ref="hrPayroll">
